    ...
    <nav id="myNavbar" class="navbar navbar-default navbar-static-top" style="position: fixed; width: 100%;">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="${configBean.contextPath?if_exists}/abilists"><img src="${configBean.contextPath?if_exists}/static/apps/img/abilists/logo01.png?2019111501" class="img-responsive" width="70" alt="abilists" /></a>
        </div>
            ...
            <#if user??>
                ...
                <li class="dropdown<#if model??><#if model.navi??><#if model.navi == 'plugins'> active</#if></#if></#if>">
	              ...
	              <ul class="dropdown-menu">
	                <li <#if model??><#if model.navi??><#if model.navi == "plugins">class="active"</#if></#if></#if>><a href="${configBean.contextPath?if_exists}/plugins"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> <@spring.message "plugins.navi.title"/></a></li>
	                <#if model??>
	                <#if model.mPluginsList?has_content>
	              		<#list model.mPluginsList as mPlugins>
	              		<li <#if model??><#if model.navi??><#if model.navi == mPlugins.mpName>class="active"</#if></#if></#if> style="margin-left: 17px;"><a href="${configBean.contextPath?if_exists}/plugins/${mPlugins.mpName?if_exists}/index">
	                ...
	                <li <#if model??><#if model.navi??><#if model.navi == "host">class="active"</#if></#if></#if>><a href="${configBean.contextPath?if_exists}/host"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> <@spring.message "client.contact.us"/></a></li>
	              </ul>
	            </li>
	        <#else>
	            <li <#if model??><#if model.navi??><#if model.navi == "abilists">class="active"</#if></#if></#if>><a href="${configBean.contextPath?if_exists}/abilists/"><@spring.message "navi.title.abilists"/></a></li>
